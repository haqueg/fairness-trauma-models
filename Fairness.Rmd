...
disease ^(1)^, with an estimated 973 million injuries requiring health
intervention in 2013 alone ^(2)^<!-- Revised this to be more
...
occur in low- and middle-income countries ^(3)^<!-- This is quite
...
injury severity scores ^(4)^, and the type and quality of trauma
...
-->. However, more women die from burns caused by fires ^(3)^. This
...
to be designed with the same perceptional disparity ^(5)^<!-- Are you
